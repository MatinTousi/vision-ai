                ...
                <div class="card shadow-lg rounded-3 " style="border: 2px solid #000000;">
                    <div class="card-header bg-white text-center py-3" style="border-bottom: 3px solid #000000;">
                        <div class="d-flex flex-column align-items-center">
                            <h4 class="fw-bold mb-0 text-dark p-5">ورود به حساب کاربری</h4>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('login.post') }}" method="post">
                            ...
                            <div class="mt-2"></div>
                            <a href="{{ route('register') }}" class="ms-2 text-decoration-none ">آیا هنوز حساب
                                ندارید؟</a>
                            <button type="submit" class="btn btn-dark w-100 mt-4">ورود</button>
                        </form>
                    </div>
                </div>
            </div>
